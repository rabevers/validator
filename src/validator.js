...
Gp.Validator    = (function(){
    ...
    var validatorStringSplitCharacter   = '&'
...
Gp.Validators   = {
    ...
    length : {
        ...
        validate : function(element, arguments){
            var isValid = false;
            var returnObject = {};


            var value   = element.val();
            if (arguments.minLength && value.length < arguments.minLength){
                returnObject.tooShort   = this.messages.tooShort;
            }
            if (arguments.maxLength && value.length > arguments.maxLength){
